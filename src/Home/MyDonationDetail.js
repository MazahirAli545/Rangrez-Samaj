...
const MyDonationDetail = ({route, props, navigation}) => {
  ...
  console.log('DonationF', donationList);
  ...
  const openWhatsApp = () => {
    const url = `https://wa.me/91${donationList.event.ENVT_CONTACT_NO}`;
  ...
  const openCheckout = async amount => {
    ...
    try {
      ...
      var options = {
        ...
        description: `Payment for ${donationList.event.ENVT_DESC}`,
        image: 'https://your-logo-url.com',
        currency: 'INR',
        key: 'rzp_test_ANawZDTfnQ7fjY',
        amount: amountInPaise.toString(),
        name: donationList.event.ENVT_DESC,
        prefill: {
      ...
      const capturePayload = {
        ...
        amount: parseFloat(amount),
        ENVIT_ID: donationList.event.ENVT_ID,
        ...
        description:
          ...
          `Payment for ${donationList.event.ENVT_DESC}`,
        ...
        cate_id: donationList.event?.ENVT_CATE_ID || 1,
      };
  ...
  return (
    <SafeAreaView style={styles.MainContainer}>
      <Animated.View
        ...
        <ImageBackground
          source={{uri: donationList.event?.ENVT_BANNER_IMAGE}} // Replace with your image source
      ...
      <Animated.ScrollView
        ...
        <KeyboardAwareScrollView
          ...
          <LinearGradient
            ...
            style={{flex: 1, paddingBottom: hp(15)}}>
            <View
              style={{
                ...
                <View>
                  <View
                    ...
                    <Text
                      ...
                      {donationList.event?.ENVT_EXCERPT}
                    </Text>
                  </View>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {donationList.event?.ENVT_DETAIL}
                    </Text>
                  </View>
                  <View
                    style={{
                    ...
                    <Text
                      ...
                      Location : {donationList.event?.ENVT_ADDRESS}
                    </Text>
                    <Text
                      style={{
                        paddingHorizontal: wp(3),
                      ...
                      City: {donationList.event?.ENVT_CITY}
                    </Text>
                  </View>
                </View>
              </View>
            ...
            <View style={{marginTop: hp(2), marginHorizontal: wp(2)}}>
              <Swiper
                ...
                {donationList.event?.ENVT_GALLERY_IMAGES &&
                  donationList.event.ENVT_GALLERY_IMAGES.split(', ').map(
                    (image, index) => (
                      <Image
                        key={index}
